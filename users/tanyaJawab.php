...
<html>
<head>
	<title>Tanya Jawab - EzToLearn</title>
...
<body class="bodyUser">
		...
		<div class="kotakTanya col-sm-7 garis spasiBawah">
			...
			<div class="row ruangKuis garis">
				<form method="post" action="proses_tanya.php">
				...
				?> -->
				<div align="right">
				<button type="submit" class="btn btn-default spasiBawah spasiKanan" align="right">Submit</button>
				</div>
				</form>
			</div>
			<div class="col-sm-1">
